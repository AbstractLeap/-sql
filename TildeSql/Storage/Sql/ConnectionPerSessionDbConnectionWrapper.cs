namespace TildeSql.Storage.Sql {
    ...
    /// <summary>
    ///     This class overrides the dispose functionality so that the disposal calls inside the session are ignored until the
    ///     whole session is disposed
    /// </summary>
    public class ConnectionPerSessionDbConnectionWrapper : DbConnection {
        ...
        public ConnectionPerSessionDbConnectionWrapper(DbConnection connection) {
            this.dbConnectionImplementation = connection;
        }
